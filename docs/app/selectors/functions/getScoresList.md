...
[CLEaN Tool](../../../modules.md) / [app/selectors](../README.md) / getScoresList

# Function: getScoresList()

> **getScoresList**(`state`): readonly readonly number[][]
...
[Projects/clean-tool-app/src/app/selectors.ts:211](https://github.com/yuckyh/clean-tool-app/)
